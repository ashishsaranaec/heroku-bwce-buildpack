...
echo "Port is $PORT and BW cloud port is $BW.CLOUD.PORT"
...
echo "Log level is ${BW_LOGLEVEL}"

echo "Calling other functions"
...
echo "Completed other functions"
...
echo "Executing start BW appnode script"
